...
import it.moise.plc.uml.interfaces.pseudostate.InterfaceEntryPoint;
 ...
 *
 */
public class EntryPoint extends PseudoState implements it.moise.plc.uml.interfaces.pseudostate.InterfaceEntryPoint {
	private String id;
	private String name;
	private String type;
	private String kind;
	 ...
	 * @param NamedNodeMap
	 */
	public EntryPoint (NamedNodeMap node){
		String delimiter ="xmi:";
		String temp[] = null;
		//System.out.println("\n**********Sezione di caricamento degli attributi *****EntryPoint - Pseudostate*************");
		...
		//System.out.println("\n**********Fine caricamento degli attributi *****EntryPoint - Pseudostate*************");
	}
	/**
	 * 
	 */
