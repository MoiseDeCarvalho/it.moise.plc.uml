 ...
 *
 */
public class Junction extends PseudoState implements it.moise.plc.uml.interfaces.pseudostate.InterfaceJunction {
	 ...
	 * @param NamedNodeMap
	 */
	public Junction (NamedNodeMap node){
		String delimiter ="xmi:";
		String temp[] = null;
		//System.out.println("\n**********Sezione di caricamento degli attributi *****Junction - Pseudostate*************");
		...
		//System.out.println("\n**********Fine caricamento degli attributi *****Junction - Pseudostate*************");
	}
	/**
	 * 
	 */
