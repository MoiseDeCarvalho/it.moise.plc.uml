 ...
 *
 */
public class Initial extends PseudoState implements it.moise.plc.uml.interfaces.pseudostate.InterfaceInitial {
	private String id = null;
	private String name = null;
	private String type = null;
	private String kind = null;
	private boolean initialPointDiAvvio = false;
	private int level = 0;
	/**
	 * Costruttore con due parametri, il primo indica il nodo, il secondo indica che è il nodo di partenza
	 * @param node
	 * @param initialPointDiAvvio
	 */
	public Initial (NamedNodeMap node, boolean initialPointDiAvvio){
		this.initialPointDiAvvio = initialPointDiAvvio;
		String delimiter ="xmi:";
		String temp[] = null;
		//System.out.println("\n**********Sezione di caricamento degli attributi *****Initial - Pseudostate*************");
		...
		//System.out.println("\n**********Fine caricamento degli attributi *****Initial - Pseudostate*************");
	}
	/**
	 * Costruttore con parametro nodo
	 * @param NamedNodeMap
	 */
	public Initial (NamedNodeMap node){
		String delimiter ="xmi:";
		String temp[] = null;
		//System.out.println("\n**********Sezione di caricamento degli attributi *****Initial - Pseudostate*************");
		for (int i=0; i < node.getLength(); i++){
	...
	public static class IdComparator implements Comparator<Initial> {
		@Override
		public int compare(Initial i1, Initial i2) {
			int result;
	...
	/**
	 * Imposta il valore di InitialPointDiAvvio, se TRUE è il primo initial Point che parte dalla State Machine ed indica il primo 
	 * stato da cui partire
	 * @param value
	 */
	public void setInitialPointDiAvvio(boolean value){
		this.initialPointDiAvvio = value;
	}
	
	/**
	 * Restituisce il valore di InitialPointDiAvvio, se TRUE è il primo initial Point che parte dalla State Machine ed indica il primo 
	 * stato da cui partire
	 * @return
	 */
	public boolean getInitialPointDiAvvio(){
		return this.initialPointDiAvvio;
	}
}
