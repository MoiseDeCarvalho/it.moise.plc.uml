 ...
 *
 */
public class Choice extends PseudoState  implements it.moise.plc.uml.interfaces.pseudostate.InterfaceShallowHistory {
	private String id = null;
	private String name = null;
	private String type = null;
	private String kind = null;
	private Comment comment = new Comment();
	private String idRegionAppartenenza = "";
	 ...
	 * @param NamedNodeMap
	 */
	public Choice (NamedNodeMap node){
		String delimiter ="xmi:";
		String temp[] = null;
		//System.out.println("\n**********Sezione di caricamento degli attributi *****Choice - Pseudostate*************");
		...
		//System.out.println("\n**********Fine caricamento degli attributi *****Choice - Pseudostate*************");
	}
	/**
	 * 
	 */
