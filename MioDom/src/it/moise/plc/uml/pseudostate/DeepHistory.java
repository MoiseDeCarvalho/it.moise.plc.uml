...
import it.moise.plc.uml.interfaces.pseudostate.InterfaceDeepHistory;
 ...
 *
 */
public class DeepHistory<T> extends PseudoState implements it.moise.plc.uml.interfaces.pseudostate.InterfaceDeepHistory {
	 ...
	 * @param NamedNodeMap
	 */
	public DeepHistory (NamedNodeMap node){
		String delimiter ="xmi:";
		String temp[] = null;
		//System.out.println("\n**********Sezione di caricamento degli attributi *****DeepHistory - Pseudostate*************");
		...
		//System.out.println("\n**********Fine caricamento degli attributi *****DeepHistory - Pseudostate*************");
	}
	/**
	 * 
	 */
