 ...
 *
 */
public class Terminate extends PseudoState implements it.moise.plc.uml.interfaces.pseudostate.InterfaceTerminate {
	 ...
	 * @param NamedNodeMap
	 */
	public Terminate (NamedNodeMap node){
		String delimiter ="xmi:";
		String temp[] = null;
		//System.out.println("\n**********Sezione di caricamento degli attributi *****Terminate - Pseudostate*************");
		...
		//System.out.println("\n**********Fine caricamento degli attributi *****Terminate - Pseudostate*************");
	}
	/**
	 * 
	 */
