 ...
 *
 */
public class Fork extends PseudoState implements it.moise.plc.uml.interfaces.pseudostate.InterfaceFork {
	 ...
	 * @param NamedNodeMap
	 */
	public Fork (NamedNodeMap node){
		String delimiter ="xmi:";
		String temp[] = null;
		//System.out.println("\n**********Sezione di caricamento degli attributi *****Fork - Pseudostate*************");
		...
		//System.out.println("\n**********Fine caricamento degli attributi *****Fork - Pseudostate*************");
	}
	/**
	 * 
	 */
