 ...
 *
 */
public class Join extends PseudoState implements it.moise.plc.uml.interfaces.pseudostate.InterfaceJoin {
	 ...
	 * @param NamedNodeMap
	 */
	public Join (NamedNodeMap node){
		String delimiter ="xmi:";
		String temp[] = null;
		//System.out.println("\n**********Sezione di caricamento degli attributi *****Join - Pseudostate*************");
		...
		//System.out.println("\n**********Fine caricamento degli attributi *****Join - Pseudostate*************");
	}
	/**
	 * 
	 */
