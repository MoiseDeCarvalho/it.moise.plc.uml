 ...
 *
 */
public class ShallowHistory extends PseudoState implements it.moise.plc.uml.interfaces.pseudostate.InterfaceShallowHistory {
	 ...
	 * @param NamedNodeMap
	 */
	public ShallowHistory (NamedNodeMap node){
		String delimiter ="xmi:";
		String temp[] = null;
		//System.out.println("\n**********Sezione di caricamento degli attributi *****ShallowHistory - Pseudostate*************");
		...
		//System.out.println("\n**********Fine caricamento degli attributi *****ShallowHistory - Pseudostate*************");
	}
	/**
	 * 
	 */
	public ShallowHistory() {
	}
	/**
	 * Set l'id
	 * @param String id
